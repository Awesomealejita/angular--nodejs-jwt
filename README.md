...
Para enseñar rápidamente el front en el navegador, abre el archivo estático [docs/preview.html](docs/preview.html) (por ejemplo, con `python -m http.server` desde la raíz y visitando `http://localhost:8000/docs/preview.html`).
